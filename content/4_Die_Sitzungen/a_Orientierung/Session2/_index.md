...
+ Erstellen Sie sich einen Padlet-Account und klonen Sie das Padlet [M4](https://padlet.com/basiskompetenzdigitalisierung/bkd2020_klon). Nun können Sie Anpassungen vornehmen und beispielsweise die Kommentarfunktion aktivieren (die bisherige Aufgabe in den [Seminarfolien](https://docs.google.com/presentation/d/1DgFsmLRMPLphKLNKLPA7UxbUlG_rG2J2pNxoQZ69JMw/edit#slide=id.g842dc49dc6_1_71) fordert die Teilnehmenden zum Kommentieren auf.) 
+ Alternativ können Sie die DSGVO-konforme Alternative [TaskCards](https://www.taskcards.de/) verwenden, die bald einen Padlet-Import ermöglichen soll (vgl. [Blogbeitrag von Michael Drabe vom 20. März 2021](https://schule-in-der-digitalen-welt.de/taskcards-eine-dsgvo-konforme-padletalternative/))

### Aufgaben

Eine Woche vor  Seminarbeginn stellen Sie den Studierenden die folgenden  Aufgaben per Link zur Verfügung

* [Aufgaben](https://lehrerbildung.github.io/5_aufgaben/session2_aufgaben_h5p/)


## Ablaufplanung 

*Die Präsentation zur folgenden Sitzung ist online verfügbar als [Google Slides](https://docs.google.com/presentation/d/1DgFsmLRMPLphKLNKLPA7UxbUlG_rG2J2pNxoQZ69JMw/edit).*
...
| 10 min  | **Erarbeitung I** <br></br> • Durchführung und Besprechung des Medienkompetenz-Bingos   | GA (10min) | [M3](https://lehrerbildung.github.io/6_zusatzmaterial/pln_bingo/) den TN als Link zur Verfügung stellen| 
| 25 min | **Erarbeitung II**<br></br>• Erkunden Sie Twitter/ unser Padlet und kommentieren Sie bestehende oder teilen Sie neue Materialien.  <br></br>• Erklären Sie abschließend, wie man Padlet/Twitter  <br></br> a) für den Austausch mit Lehrkräften<br></br> b) im Unterricht einsetzen könnte <br></br> | EA (10min) <br></br> <br></br> <br></br><br></br>1-4-all (15min) | [M4](https://padlet.com/basiskompetenzdigitalisierung/bkd2020_klon), [#basiskompdigi](https://twitter.com/hashtag/basiskompdigi)<br></br> Brainstorming alleine (2min) Austausch zu viert in BreakOut-Räumen mit Ergebnissicherung in geteilten Notizen (8min) => Zusammenführung im "Plenum". Gruppen posten abwechselnd ihre Ergebnisse in Notizen (5min)    |
...
| M3 | Medienkompetenz-Bingo als [h5p-Element](https://github.com/Lehrerbildung/BKD-github/raw/main/content/h5pElemente/2-PLN-Bingo.h5p) basierend auf einer Vorlage von Sonja Henning [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/deed.de) [(Blog)](https://sonnigeeinsichten.jimdofree.com/2018/12/02/auf-schatzsuche-im-kollegium-mit-dem-medienkompetenzbingo/) | 
